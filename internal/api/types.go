...
type Config struct {
	...
	HTTPClient     *http.Client      // optional; if nil, a default transport is constructed
	DefaultHeaders map[string]string // optional headers added to every API request (e.g. preview flags)
}
